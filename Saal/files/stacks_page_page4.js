...
stacks.stacks_in_889_page4 = {};
stacks.stacks_in_889_page4 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(function() {


$(document).ready(function() {
	$('#stacks_in_889_page4 .bricks-item').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
	if(!(/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/i).test(navigator.userAgent || navigator.vendor || window.opera)){
	  $(".stacks_top").css("overflow", "visible");
	}

	
		$('#stacks_in_889_page4 .bricks_wrapper').hide();
		$('#stacks_in_889_page4 .bricks_loader').fadeIn(400);
...
$(window).load(function() {
		...
		$('#stacks_in_889_page4 .bricks_loader').remove();
		$('#stacks_in_889_page4 .bricks_wrapper').fadeIn(800);
	

	$("#stacks_in_889_page4 .bricks_wrapper").gridalicious({
		...
		if(!(/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/i).test(navigator.userAgent || navigator.vendor || window.opera)){
		  ...
		  $('#stacks_in_889_page4 .bricks-item').css({'opacity':'0'}).each(function(count) {
...
return stack;})(stacks.stacks_in_889_page4);